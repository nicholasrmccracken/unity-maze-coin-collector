...
namespace ShareefSoftware
{
    public class LevelGeneration : MonoBehaviour
    {
        ...
        [SerializeField] GridTraversal<int>.AlgorithmType algorithmType = GridTraversal<int>.AlgorithmType.Prim;
        ...
        private void Awake()
        {
            ...
            var maze = new Maze(numberOfRows, numberOfColumns, random, algorithmType);

            exitSpawner.Initialize(numberOfRows, numberOfColumns, cellWidth, cellHeight);
            coinSpawner.Initialize(maze, cellWidth, cellHeight);
        ...
        public List<GameObject> GetPathNeighbors(float searchRadiusMultiplier = 1.5f)
        {
            List<GameObject> neighbors = new List<GameObject>();

            float searchRadius = this.cellWidth * searchRadiusMultiplier;
